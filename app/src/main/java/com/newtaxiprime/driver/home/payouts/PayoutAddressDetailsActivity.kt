...
import com.newtaxiprime.driver.databinding.ActivityPayoutAddressDetailsBinding
import com.newtaxiprime.driver.home.datamodel.PayoutData
...
import com.newtaxiprime.driver.home.payouts.payout_model_classed.CountryModel
import com.newtaxiprime.driver.home.payouts.payout_model_classed.CountryResult
...
class PayoutAddressDetailsActivity : CommonActivity(), View.OnClickListener, ServiceListener,
    ...
    lateinit var binding: ActivityPayoutAddressDetailsBinding
        ...
        when (v.id) {
            R.id.payout_next -> {
                ...
                if (address_street == "") {
                    ...
                    commonMethods.snackBar(
                        resources.getString(R.string.error_city),
                        "",
                        false,
                        2,
                        payoutaddress_street,
                    ...
                    commonMethods.snackBar(
                        resources.getString(R.string.error_msg_state),
                        "",
                        false,
                        2,
                        payoutaddress_street,
                    ...
                    commonMethods.snackBar(
                        resources.getString(R.string.error_zip_code),
                        "",
                        false,
                        2,
                        payoutaddress_street,
