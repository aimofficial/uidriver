...
import com.newtaxiprime.driver.common.util.Enums.REQ_COMMON_DATA
import com.newtaxiprime.driver.common.util.Enums.REQ_DRIVER_STATUS
import com.newtaxiprime.driver.common.util.Enums.REQ_HEAT_MAP
...
import com.newtaxiprime.driver.common.util.Enums.UPDATE_DEFAULT_VEHICLE
import com.newtaxiprime.driver.common.util.RequestCallback
import com.newtaxiprime.driver.databinding.FragmentHomeBinding
import com.newtaxiprime.driver.google.locationmanager.PositionProvider
...
import com.newtaxiprime.driver.home.MainActivity.Companion.selectedFrag
import com.newtaxiprime.driver.home.datamodel.CommonData
import com.newtaxiprime.driver.home.datamodel.HeatMap
...
import com.newtaxiprime.driver.home.managevehicles.DocumentDetails
import com.newtaxiprime.driver.home.managevehicles.ManageVehicles
import com.newtaxiprime.driver.home.map.AppUtils
import com.newtaxiprime.driver.home.service.HeatMapUpdation
import com.newtaxiprime.driver.trips.RequestAcceptActivity
...
*/
    ...
    fun checkStatus() {
        apiService.updateCheckStatus(status)
            .enqueue(RequestCallback(REQ_DRIVER_STATUS, this@HomeFragment))
    }
    ...
    override fun onCreateView(
        ...
        v = binding.root
        rbHeatMap = binding.rbHeatMap
        tv_addDriverProof = binding.tvAddDriverProoof
        tv_addDriverProof.setOnClickListener {
            addDriverProof()
        }

        tv_addVehicle = binding.tvAddVehicle

        tv_addVehicle.setOnClickListener {
            addVehicle()
        }

        rtl_driver_details = binding.rtlDriverDetails

        rltSelectedcar = binding.rltSelectedCar

        rlt_documentdetails = binding.rtlDocumentDetails

        btn_checkstatus = binding.btnCheckStatus

        btn_checkstatus.setOnClickListener {
 ...
 */
    ...
    private fun onSuccessIncompleteTripDetails(jsonResp: JsonResponse) {
        ...
        sessionManager.tripOtp = tripDetailsModel.riderDetails.get(0).otp.toString()
