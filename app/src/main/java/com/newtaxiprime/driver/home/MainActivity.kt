...
import com.newtaxiprime.driver.common.custompalette.CustomTypefaceSpan
...
import com.newtaxiprime.driver.common.helper.Constants.RequestEndTime
...
import com.newtaxiprime.driver.common.util.CommonMethods.Companion.startFirebaseChatListenerService
import com.newtaxiprime.driver.common.util.CommonMethods.Companion.stopFirebaseChatListenerService
import com.newtaxiprime.driver.common.util.Enums
import com.newtaxiprime.driver.common.util.Enums.REQ_DEVICE_STATUS
import com.newtaxiprime.driver.common.util.Enums.REQ_DRIVER_PROFILE
import com.newtaxiprime.driver.common.util.Enums.REQ_DRIVER_STATUS
import com.newtaxiprime.driver.common.util.Enums.REQ_UPDATE_ONLINE
import com.newtaxiprime.driver.common.util.RequestCallback
import com.newtaxiprime.driver.common.views.CommonActivity
import com.newtaxiprime.driver.databinding.ActivityMainBinding
import com.newtaxiprime.driver.databinding.AppBarHomeToolbarViewBinding
import com.newtaxiprime.driver.google.locationmanager.TrackingService
import com.newtaxiprime.driver.google.locationmanager.TrackingServiceListener
import com.newtaxiprime.driver.google.locationmanager.UpdateLocations
...
import com.newtaxiprime.driver.home.fragments.payment.AddWalletActivity
import com.newtaxiprime.driver.home.interfaces.ApiService
import com.newtaxiprime.driver.home.interfaces.ServiceListener
import com.newtaxiprime.driver.home.managevehicles.SettingActivity
...
import com.newtaxiprime.driver.trips.RequestReceiveActivity
...
class MainActivity : CommonActivity(), ServiceListener {
    ...
    lateinit var appBarToolBar: AppBarHomeToolbarViewBinding
    ...
    * */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarToolBar = binding.appBarHead.appBarToolBar
        ...
        txt_checkdriverstatus = appBarToolBar.txtCheckdriverstatus
        txt_checkdriverstatus.setOnClickListener {
            txtCheckDriverStatus()
        }

        view = appBarToolBar.view

        homelist = appBarToolBar.homelist

        coordinatorLayout = binding.root

        ivLine = appBarToolBar.ivLine

        mDrawerLayout = binding.drawerLayout

        toolbar = binding.appBarHead.toolbar

        labled_switch = appBarToolBar.labledSwitch


        tvStatus = appBarToolBar.tvStatus
        ...
        binding.gotorider.setOnClickListener {
            GotoRider()
        }
        /*
        ...
        initNavitgaionview()
        initView()
        // Set the item you want to be active
        bottomNavigationView.menu.findItem(R.id.create_ride).isChecked = true
    ...
    private fun bottomnav() {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.create_ride -> {
                    val profileIntent = Intent(this, PlaceSearchActivity::class.java)
    ...
    **/
    fun loadData(driverProfileModel: DriverProfileModel) {
        ...
        sessionManager.walletAmount = driverProfileModel.walletAmount
        sessionManager.walletAccount = driverProfileModel.walletAccount
        ...
        val carImage = findViewById<ImageView>(R.id.ivCar)

        Picasso.get().load(user_thumb_image).into(carImage)
