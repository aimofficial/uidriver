...
import com.newtaxiprime.driver.common.util.Enums.REQ_CURRENCYLIST
import com.newtaxiprime.driver.common.util.RequestCallback
import com.newtaxiprime.driver.common.views.CommonActivity
import com.newtaxiprime.driver.databinding.ActivityPayoutEmailListBinding
...
import com.newtaxiprime.driver.home.payouts.payout_model_classed.PayoutDetail
import com.newtaxiprime.driver.home.payouts.payout_model_classed.PayoutDetailResult
...
class PayoutEmailListActivity : CommonActivity(), View.OnClickListener, ServiceListener {
    ...
    lateinit var binding: ActivityPayoutEmailListBinding
    ...
    fun loadPayout() {
        ...
        apiService.payoutDetails(sessionManager.accessToken!!)
