...
import com.newtaxiprime.driver.common.util.Enums.REQ_NUM_VALID
...
import com.newtaxiprime.driver.databinding.ActivityRegisterotpBinding
...
class RegisterOTPActivity : CommonActivity(), ServiceListener {
    ...
    lateinit var binding: ActivityRegisterotpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        codetext = binding.codetext


        resend_timer = binding.resendTimer
