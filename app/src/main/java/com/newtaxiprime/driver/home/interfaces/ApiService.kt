...
interface ApiService {
    ...
    @FormUrlEncoded
    @POST("pay_to_admin_wallet")
    fun payToAdminWallet(@FieldMap walletParams: LinkedHashMap<String, String>): Call<ResponseBody>

    // Send OwnAmount
    @FormUrlEncoded
    @POST("pay_to_admin_wallet")
    fun payToAdminWallet(@Field("amount") amount: String, @Field("applied_referral_amount") applyRefer: String, @Field("token") token: String): Call<ResponseBody>
   ...
   //Create Ride
    @FormUrlEncoded
    @POST("driver_create_ride")
    fun createRide(@Field("pickup_address") pickupaddress: String,@Field("car_id") carId: String, @Field("destination_address") dropaddress: String, @Field("token") token: String): Call<ResponseBody>
   //Transfer Money
   @FormUrlEncoded
   @POST("transfer_money")
