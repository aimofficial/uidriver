...
import com.newtaxiprime.driver.databinding.AppActivitySigninSignupHomeBinding
...
class SigninSignupHomeActivity : CommonActivity(), UserChoiceSuccessResponse {
    ...
    lateinit var binding: AppActivitySigninSignupHomeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        looking = binding.looking

        looking.setOnClickListener {
            looking()
        }

        LanguageChange = binding.ivLanguagechange

        language = binding.languagetext

        relativeLayout = binding.activitySigninSignupHome
    ...
    fun languagelist() {
        ...
        com.newtaxiprime.driver.home.signinsignup.SigninSignupHomeActivity.Companion.alertDialogStores?.setOnDismissListener {
