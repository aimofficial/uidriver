...
import com.newtaxiprime.driver.common.util.Enums.REQ_RIDER_PROFILE
import com.newtaxiprime.driver.common.util.Enums.REQ_UPCOMING_TRIPS
...
class PendingTripsFragment : Fragment(), ServiceListener, PaginationAdapterCallback {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        recyclerView = rootView.findViewById(R.id.current_recycler_view)
