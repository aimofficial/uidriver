...
import com.newtaxiprime.driver.common.util.Enums.REQ_CASH_COLLECTED
import com.newtaxiprime.driver.common.util.Enums.REQ_GET_INVOICE
import com.newtaxiprime.driver.common.util.RequestCallback
import com.newtaxiprime.driver.common.views.CommonActivity
import com.newtaxiprime.driver.databinding.ActivityPaymentAmountPageBinding
import com.newtaxiprime.driver.home.MainActivity
import com.newtaxiprime.driver.home.datamodel.InvoiceModel
import com.newtaxiprime.driver.home.datamodel.TripInvoiceModel
...
class PaymentAmountPage : CommonActivity(), ServiceListener {
    ...
    // lateinit var adapter: PriceRecycleAdapter
    lateinit var binding: ActivityPaymentAmountPageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adminamountlayout = binding.adminamountlayout
        oweamountlayout = binding.oweamountlayout
        driverpayoutlayout = binding.driverpayoutlayout
        cashcollectamountlayout = binding.cashcollectamountlayout

        basefare_amount = binding.basefareAmount
        distance_fare = binding.distanceFare
        time_fare = binding.timeFare
        fee = binding.fee
        totalamount = binding.totalamount
        total_payouts = binding.totalPayouts
        oweamount = binding.oweamount
        driverpayout = binding.driverpayout
        adminamount = binding.adminamount
