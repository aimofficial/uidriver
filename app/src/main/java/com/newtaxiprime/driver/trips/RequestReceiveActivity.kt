...
import com.newtaxiprime.driver.common.helper.CircularMusicProgressBar
import com.newtaxiprime.driver.common.helper.CustomDialog
import com.newtaxiprime.driver.common.helper.WaveDrawable
...
import com.newtaxiprime.driver.databinding.AppActivityRequestReceiveBinding
...
import com.newtaxiprime.driver.trips.timelineview.LocationTimeLineView
...
class RequestReceiveActivity : CommonActivity(), LinearTimer.TimerListener, ServiceListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rltAnim = binding.requestReceiveDialogLayout
        map_snap = binding.mapSnap
        tvDecline = binding.tvDecline
        tvSeatCount = binding.tvSeatCount
        linearTimerView = binding.linearTimer
        tvcountdowntimer = binding.tvcountdowntimer
        req_min = binding.reqMin

        tvDecline.setOnClickListener {
            decline()
        }

        map_snap.setOnClickListener {
            imageclick()
        }
...
//        locationHashMap["pickup_longitude"] = pickup?.longitude.toString()
    ...
    fun accept() {
        ...
        drawable.setColorFilter(
            ContextCompat.getColor(this, R.color.newtaxi_app_navy),
