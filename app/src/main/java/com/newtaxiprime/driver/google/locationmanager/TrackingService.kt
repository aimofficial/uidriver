package com.newtaxiprime.driver.google.locationmanager
...
import com.newtaxiprime.driver.common.helper.Constants.notificationIcon
...
class TrackingService : Service() {
    ...
    override fun onCreate() {
        ...
        mFirebaseDatabaseRequest = mFirebaseInstance.getReference(applicationContext.getString(com.newtaxiprime.driver.R.string.real_time_db))
