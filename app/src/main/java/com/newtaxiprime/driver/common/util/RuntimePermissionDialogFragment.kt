...
class RuntimePermissionDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        permissionTypeImage = rootView.findViewById<ImageView>(R.id.imgv_df_permissionImage)
        permissionAllow = rootView.findViewById<TextView>(R.id.tv_df_permissionAllow)
        permissionNotAllow = rootView.findViewById<TextView>(R.id.tv_df_permissionNotAllow)
        tv_permissionDescription = rootView.findViewById<TextView>(R.id.tv_df_permissionDescription)
        permissionNotAllow.setOnClickListener {
            notAllowPermission()
        }
     ...
     * first add in permission list and then add icon list*/
        ...
        val CAMERA_PERMISSION_ARRAY = arrayOf(CAMERA_PERMISSION, READ_MEDIA_IMAGES)
        val STORAGEPERMISSIONARRAY = arrayOf(READ_MEDIA_IMAGES)
        val IMAGE_PERMISSION_ARRAY = arrayOf(CAMERA_PERMISSION, READ_MEDIA_IMAGES)
         ...
         * because some custom phone below Android M request permission from user at Run time example: redmi phones*/
            ...
            if ((!allPermissionGranted!!)!!) {
                if (shouldAskPermissionForThisAndroidOSVersion()) {
                    ...
                    runtimePermissionDialogFragment.requestCodeForCallbackIdentification =
                        requestCodeForCallbackIdentification
