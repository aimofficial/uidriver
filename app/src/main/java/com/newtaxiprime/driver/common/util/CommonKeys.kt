...
object CommonKeys {
    ...
    val WEB_MPESA_PAY_TO_ADMIN = "mpesa_web_payment?"
    val WEB_PAYTM_PAY_TO_ADMIN = "paytm_web_payment?"
    val WEB_FLUTTERWAVE_TO_ADMIN = "flutterwave_web_payment?"
    val WEB_RAZORPAY_TO_ADMIN = "razorpay_web_payment?"
    val WEB_MOLLIE_TO_ADMIN = "mollie_web_payment?"
    val WEB_PAYSTACK_TO_ADMIN = "paystack_web_payment?"
    val PAY_TO_ADMIN = "pay_to_admin"
