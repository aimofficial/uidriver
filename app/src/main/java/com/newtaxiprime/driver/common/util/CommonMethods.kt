package com.newtaxiprime.driver.common.util
...
import com.newtaxiprime.driver.common.custompalette.FontCache
...
import com.newtaxiprime.driver.common.helper.ManualBookingDialog
...
*/
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    if (token != null) {
                        pos = token
                        sessionManager.deviceId = pos
                        println("Device Id: $pos")
                    } else {
                        println("Device Id is null")
                    }
                } else {
                    val exception = task.exception
                    println("Device Id Exception: $exception")
                }
            }
    ...
    fun manualBookingTripStarts(jsonResp: JSONObject, context: Context) {
        ...
        sessionManager.tripOtp = riderModel.riderDetails.get(0).otp
    ...
    fun setButtonText(string: String, view: FontButton) {
        view.text = string
    }
