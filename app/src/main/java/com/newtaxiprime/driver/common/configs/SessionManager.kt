package com.newtaxiprime.driver.common.configs
...
class SessionManager {
    ...
    var walletPaymentMethod: String?
        get() = sharedPreferences.getString("walletpaymentmethod", "stripe")
    ...
    var tripOtp: String?
        get() = sharedPreferences.getString("tripOtp", "")
        set(tripOtp) = sharedPreferences.edit().putString("tripOtp", tripOtp).apply()
